                                ...
                                <form method="POST" action="{{ route('anuncios.update', ['anuncio' => $anuncio->id]) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="año"
                                            class="form-control @error('año') is-invalid @enderror" id="año"
                                            placeholder="Ej. 2010" value="{{ $anuncio->año }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="condicion"
                                            class="form-control @error('condicion') is-invalid @enderror" id="condicion">
                                            <option value="">-- Seleccione --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tipo_carro"
                                            class="form-control @error('tipo_carro') is-invalid @enderror" id="tipo_carro">
                                            <option value="">-- Seleccione --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_puertas"
                                            ...
                                            id="total_puertas" placeholder="Ej. 4" value="{{ $anuncio->total_puertas }}"
                                            min="1" max="6" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="precio"
                                                ...
                                                placeholder="Ej. 10,000" value="{{ $anuncio->precio }}" min="0"
                                                step="any" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="kilometraje"
                                            ...
                                            placeholder="Ej. 10,000" value="{{ $anuncio->kilometraje }}" min="0"
                                            step="any" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="estado" class="form-control @error('estado') is-invalid @enderror"
                                            ...
                                            @foreach ($estadoCarro as $estado)
                                                <option value="{{ $estado->id }}"
                                                    {{ $anuncio->estado_id == $estado->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="municipio"
                                            ...
                                            @foreach ($municipioCarro as $municipio)
                                                <option value="{{ $municipio->id }}"
                                                    {{ $anuncio->municipio_id == $municipio->id ? 'selected' : '' }}>
                                                    ...
                                                    <div id="idimagen-{{ $image->id }}" class="col-sm-2">
                                                        <a href="{{ $image->url }}" data-toggle="lightbox"
                                                            ...
                                                            <img style="width:150px; height:150px;"
                                                                src="{{ asset($image->url) }}" class="img-fluid mb-2" />
                                                        </a>
                                                    </div>
