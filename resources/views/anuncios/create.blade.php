                                ...
                                <form method="POST" action="{{ route('anuncios.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="año"
                                            ...
                                            placeholder="Ej. 2010" value="{{ old('año') }}" />
                                        ...
                                        <select name="tipo_carro"
                                            ...
                                            @foreach ($tipoCarros as $tipo_carro)
                                                <option value="{{ $tipo_carro->id }}"
                                                    {{ old('tipo_carro') == $tipo_carro->id ? 'selected' : '' }}>
                                        ...
                                        <select name="combustible"
                                            ...
                                            @foreach ($combustible as $combustible)
                                                <option value="{{ $combustible->id }}"
                                                    {{ old('combustible') == $combustible->id ? 'selected' : '' }}>
                                        ...
                                        <select name="condicion"
                                            ...
                                            @foreach ($condicion as $condicion)
                                                <option value="{{ $condicion->id }}"
                                                    {{ old('condicion') == $condicion->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="precio"
                                                ...
                                                placeholder="Ej. 10,000" value="{{ old('precio') }}" min="0"
                                                step="any" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="kilometraje"
                                            ...
                                            placeholder="Ej. 10,000" value="{{ old('kilometraje') }}" min="0"
                                            step="any" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <trix-editor input="descripcion"
                                            class="form-control @error('descripcion') is-invalid @enderror "></trix-editor>
